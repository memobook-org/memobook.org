...
<template>
  ...
  <div id="privacy">
    ...
    <p>
      At memobook, accessible from downloading the app at
      https://memobook.80px.com, one of our main priorities is the privacy of
      our visitors. This Privacy Policy document contains types of information
      that is collected and recorded by memobook and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in memobook. This policy is not applicable to any
      information collected offline or via channels other than this website. Our
      Privacy Policy was created with the help of the
      <a class="text-dark" href="https://www.privacypolicygenerator.info"
    ...
    <p>
      memobook follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, memobook uses 'cookies'. These cookies are used to
    ...
    <p>
      ...
      <a class="text-dark" href="https://www.generateprivacypolicy.com/#cookies"
    ...
    <p>
      ...
      advertising partners of memobook.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on memobook, which are sent directly
    ...
    <p>
      Note that memobook has no access to or control over these cookies that are
    ...
    <p>
      memobook's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      memobook does not knowingly collect any Personal Identifiable Information
