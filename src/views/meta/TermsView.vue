...
<template>
  ...
  <div id="terms">
    ...
    <p>Welcome to memobook!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of memobook's Website, located at the app downloadable at
      https://memobook.80px.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use memobook if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing memobook, you agreed to use
      cookies in agreement with the memobook's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, memobook and/or its licensors own the
      intellectual property rights for all material on memobook. All
      intellectual property rights are reserved. You may access this from
      memobook for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from memobook</li>
      <li>Sell, rent or sub-license material from memobook</li>
      <li>Reproduce, duplicate or copy material from memobook</li>
      <li>Redistribute content from memobook</li>
    </ul>
    ...
    <p>
      ...
      <a
        class="btn btn-text mx-0 my-0 px-0 py-0 bx-0 by-0 text-dark"
    ...
    <p>
      ...
      opinions and information in certain areas of the website. memobook does
      ...
      memobook,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, memobook shall not be liable for the
    ...
    <p>
      memobook reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant memobook a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of memobook; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to memobook. Please include your name, your organization name,
    ...
    <p>
      No use of memobook's logo or other artwork will be allowed for linking
